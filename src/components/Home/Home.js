    ...
    return (
        <div>
            <div className='grid grid-cols-1 md:grid-cols-2  items-center bg-orange-500 py-5 mb-3 '>
                <div className='container flex justify-center px-36 '>
                    <h1 className='text-white'><span className=' text-2xl md:text-5xl font-bold'>Hero text here Hero text here   </span> <br /> second linesecond linesecond line</h1>
                </div>
